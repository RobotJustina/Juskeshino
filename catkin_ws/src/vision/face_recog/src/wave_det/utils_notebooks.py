...
def spawn_object(gazebo_name, name, x, y, z, yaw,roll=0.0 , pitch=0.0):
    ...
    _path_xml = '/home/lorena/Tutorials/catkin_tutorials/src/tmc_wrs_gazebo_world/models/MODEL_NAME/model-1_4.sdf'
    
    
                                                
    _path_model = '/home/lorena/Tutorials/catkin_tutorials/src/tmc_wrs_gazebo_world/models/'
