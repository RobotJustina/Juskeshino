...
def pca(x_points, y_points, z_points):    
    """
...
def callback_RecognizeObject(req):  # Request is a PointCloud2
    ...
    if obj_in_stage:
        ...
        resp.recog_object.pose.position.x = centroide_cam[0] + 0.02
        resp.recog_object.pose.position.y = centroide_cam[1]
        resp.recog_object.pose.position.z = centroide_cam[2] + 0.05
