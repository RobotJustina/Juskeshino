...
class CommandGenerator:
    ...
    def __init__(self, person_names, location_names, placement_location_names, room_names, object_names,
        ...
        print("Person names: ", [w.upper() for w in person_names])
        print("Location names: ", [w.upper() for w in location_names])
        print("Placement loc names: ", [w.upper() for w in placement_location_names])
        print("Room names: ", [w.upper() for w in room_names])
        print("Object names: ", [w.upper() for w in object_names])
        print("Obj cat plural: ", [w.upper() for w in object_categories_plural])
        print("Obj cat singular: ", [w.upper() for w in object_categories_singular])
    ...
    print("Color clothe list", color_clothe_list)
    print("Color clothes list", color_clothes_list)
