...
def main():
    ...
    req_effort_left.joint_name  = 'baixue::wheel_left_joint'
    req_effort_right.joint_name = 'baixue::wheel_right_joint'
    req_effort_back.joint_name  = 'baixue::wheel_back_joint'
    ...
    req_prop_left.joint_name  = 'baixue::wheel_left_joint'
    req_prop_right.joint_name = 'baixue::wheel_right_joint'
    req_prop_back.joint_name  = 'baixue::wheel_back_joint'
    loop = rospy.Rate(RATE)
    
    req_model_state = GetModelStateRequest()
    req_model_state.model_name = 'baixue'
