...
import open3d, os
import torch
from vis.visualization_utils import get_hand_geometry
import transforms3d
...
def inv_transform_grasp(grasp_trans):
    ...
    return matrix.cpu().numpy(), grasp_score_ori.cpu().numpy()
...
if __name__ == '__main__':
    ...
    #path = "./test_file/virtual_data_predict/3271_view_0.p"
    path = "./test_file/real_data_predict/0000_cloud.p"
    #path = "./ros/Processed_pc2.p"
    stage = 'grasp_stage3_score'
    score_thre = 0.5
