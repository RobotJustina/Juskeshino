...
(cl:in-package conceptual_deps-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <StringArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conceptual_deps-msg:<StringArray> is deprecated: use conceptual_deps-msg:StringArray instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <StringArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conceptual_deps-msg:data-val is deprecated.  Use conceptual_deps-msg:data instead.")
  (data m))
